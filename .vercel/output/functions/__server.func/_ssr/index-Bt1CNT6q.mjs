...
const appDoor = "/assets/son-thep-ma-kem-lotus-nxrBAL1P.jpg";
const project1 = "/assets/son-cau-thang-lan-can-lotus-CvomOIU8.jpg";
...
function Decision() {
  ...
  const standardSteps = [
    ...
    },
    {
      ...
      desc: "Sơn tiếp 1 lớp phủ màu Lotus Metal Coat Finish sau khi lớp lót đã khô (khoảng 2 giờ). Đảm bảo bề mặt lên màu chuẩn xác, mịn bóng và kháng tia UV.",
      icon: Paintbrush
    },
    {
      step: 4,
  ...
  const items = [
    {
      ...
      area: "TP.HCM",
      quote: "Trước giờ toàn dùng sơn dầu, lần này thử Lotus thấy khác hẳn — không có mùi xăng, sơn xong ở nhà luôn được. Bề mặt ra đẹp, mịn không thua gì sơn dầu.",
    ...
    },
    {
      ...
      system: "Primer + Finish",
      area: "Bình Dương",
      quote: "Dùng hệ Primer + Finish cho lan can cầu thang sắt — bám dính cực tốt, bền bỉ ngoài trời. Thi công nhanh hơn sơn dầu, không mùi xăng, sơn xong ở nhà luôn được.",
